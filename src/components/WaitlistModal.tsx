        ...
        {isSuccess ? (
          <div className="flex flex-col items-center gap-4 py-6 px-4 bg-sage/10 rounded-2xl border border-sage/20">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Te avisaremos assim que estiver disponível. Bem-vinda!
              </p>
            </div>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2 text-left">
              <Label htmlFor="waitlist-name" className="text-foreground/80">Seu nome</Label>
              <Input
                id="waitlist-name"
                type="text"
            ...
            <div className="space-y-2 text-left">
              <Label htmlFor="waitlist-email" className="text-foreground/80">Seu e-mail</Label>
              <Input
                id="waitlist-email"
                type="email"
            ...
            <div className="space-y-2 text-left">
              <Label htmlFor="waitlist-phone" className="text-foreground/80">WhatsApp</Label>
              <Input
                id="waitlist-phone"
                type="tel"
